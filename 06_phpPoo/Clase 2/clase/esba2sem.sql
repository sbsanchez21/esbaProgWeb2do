...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2023 a las 00:40:51
...
(1, 'jperez@gmail.com', '123'),
(2, 'pboxer1', 'fU7%)xph~uv@u'),
(3, 'mmyderscough2', 'oO9*$AA3fgug?d(L'),
(4, 'aelham3', 'xO2|iD<)O'),
(5, 'ccareswell4', 'gX8.mV}BV6TJK!xJ'),
(6, 'lgentery5', 'mZ1.R/Jsl1imVB'),
(7, 'jcroix6', 'aU7}A?ev'),
(8, 'cbilbie7', 'dK0,lw*`%BxW'),
(9, 'omcjury8', 'aM7|IgNRUk.r0s#'),
(10, 'hdeville9', 'oE9~L6r(r53TX');
