...
<body>
    <!-- TODO: recibir id parámetro, buscar en db los datso y mostrar en menú nomb, ape y foto -->
    <!-- menu -->
    ...
    <div class="d-flex justify-content-center flex-wrap">
        ...
        while ($orador = $result->fetch_assoc()) {
            $foto=$orador["fotoPerfil"];
            $nom=$orador["nombre"];
            $ape=$orador["apellido"];
            $temas=$orador["temas"];
            echo "<div class='card mx-1' style='width: 18rem;'>";
            echo "<img src='$foto' class='card-img-top' alt='$nom'>";
            echo "<div class='card-body'>";
            echo "<div class='botones mb-3'>";
            echo "<a href='#' class='btn btn-sm btn-warning'>Javascript</a>";
            echo "<a href='#' class='btn btn-sm btn-info text-light'>React</a>";
            echo " </div>";
            echo "<h5 class='card-title'>$nom $ape</h5>";
            echo "<p class='card-text'>$temas</p>";
            echo "</div>";
            echo "</div> ";
        }
